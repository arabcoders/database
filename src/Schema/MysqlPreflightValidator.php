...
final readonly class MysqlPreflightValidator
{
    ...
    private function estimateColumnBytes(TableDefinition $table, ColumnDefinition $column, string $keyName, ?int $prefixLength): ?int
    {
        return match ($column->type) {
            ...
            ColumnType::Int, ColumnType::Float, ColumnType::Timestamp => 4,
            ColumnType::BigInt, ColumnType::Double, ColumnType::DateTime, ColumnType::Set => 8,
            ColumnType::Decimal => $this->decimalBytes($column),
            ColumnType::Date, ColumnType::Time => 3,
