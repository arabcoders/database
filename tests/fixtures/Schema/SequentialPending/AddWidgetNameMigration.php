...
#[Migration(id: '2', name: 'add_pending_widget_name')]
final class AddWidgetNameMigration extends SchemaBlueprintMigration
{
    public function change(Blueprint $blueprint): void
    {
        $blueprint->table('pending_widgets', static function (TableBlueprint $table): void {
            $table->addColumnOperation(new ColumnDefinition('name', ColumnType::Text, nullable: true));
        });
    }
}
